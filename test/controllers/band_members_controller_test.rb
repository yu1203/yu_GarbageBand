...
class BandMembersControllerTest < ActionController::TestCase
  ...
  test "should create band_member" do
    assert_difference('BandMember.count') do
      post :create, band_member: { email: @band_member.email, instrument: @band_member.instrument, looking_for: @band_member.looking_for, name: @band_member.name }
    end
  ...
  test "should update band_member" do
    patch :update, id: @band_member, band_member: { email: @band_member.email, instrument: @band_member.instrument, looking_for: @band_member.looking_for, name: @band_member.name }
    assert_redirected_to band_member_path(assigns(:band_member))
  end
